    ...
    // UPDATE PEAK POINTS
        ...
        if (Excursion_Flag) {
            ...
            if (dU > 0) {
                ...
                if ( (posFlocal < posFglobal) && (Klocal > Kglobal)) {
                    Branch     	= 2;
                    Kreload   	= Klocal;
                }
                else {
                    // Branch      = 3;
                    // Kreload     = Fpinch        / (Upinch       - u0);
                    Branch     	= 4;
                    Kreload   	= Kglobal;
                }
            }
                ...
                if ( (negFlocal > negFglobal) && (Klocal > Kglobal)) {
                    Branch     	= 12;
                    Kreload   	= Klocal;
                }
                else {
